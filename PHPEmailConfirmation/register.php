<?php
	...
	if (isset($_POST['submit'])) {
		$con = new mysqli('localhost', 'zerterra', 'zerterra', 'zerterra');
		...
		if ($name == "" || $email == "" || $password != $cPassword)
			...
			if ($sql->num_rows > 0) {
                ...
                $mail = new PHPMailer();
                $mail->setFrom('admin@zerterra.com');
                ...
                $mail->Body = "
                    ...
                    <a href='http://zerterra.com/PHPEmailConfirmation/confirm.php?email=$email&token=$token'>Click Here</a>
                ";
