                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p style=" line-height: 2; font-family: Montserrat;font-weight: bold; font-size:  11pt; text-align:justify;">
                                                                    We already received you message from our website ( zerterra.com ). Please wait while we are processing your request. Make sure that all of your informations are correct.

                                                                </p>
                                                                <p style="  font-family: Montserrat;font-weight: bold; font-size:  11pt; text-align:justify;"> Thank you for your concern</p>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 25px 0 0 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                                                ...
                                                                <table style="width:100%; height:200px;">
                                                                    ...
                                                                    <tr style="color: #000; font-family:Montserrat; font-size: 16px; line-height: 20px; font-weight:bold;">
                                                                        <td>Message:</td>
                                                                        <td style="padding-left:10px"><?php echo $message;?></td>
                                                                    </tr>
