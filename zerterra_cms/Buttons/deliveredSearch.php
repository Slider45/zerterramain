...
<div class="modal" id="deliveredSearchModal">
  ...
  <div class="modal-card">
   ...
   <form method="POST" action="delivered.php" class="modal-card-body" style="border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;" >
     <div class="field">   
      <div class="control">
