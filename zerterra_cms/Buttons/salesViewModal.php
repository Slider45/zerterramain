    ...
    <div class="field">
      ...
      <div class="control">
         <div class="columns">
              ...
              <div class="column" id="txtbox"><input class="input"   value="<?php echo $firstname; ?>" disabled="disabled"></div>
         </div>
      </div>
      <div class="control">
         <div class="columns">
              <div class="column is-2" id="label">Lastname:</div>
              <div class="column" id="txtbox"><input class="input"   value="<?php echo $lastname; ?>"  disabled="disabled"></div>
         </div>
      </div>
      <div class="control">
        <div class="columns">
      ...
      <div class="control">
        <div class="columns">
              <div class="column is-2" id="label">Vat:</div>
              <div class="column" id="txtbox"><input class="input"  value="<?php echo $vat ?>"  disabled="disabled"></div>
         </div>
      </div>
      <div class="control">
        <div class="columns">
              <div class="column is-2" id="label">Date Purchased:</div>
              <div class="column" id="txtbox"><input class="input"  value="<?php echo $datePurchased ?>"  disabled="disabled"></div>
         </div>
      </div>
