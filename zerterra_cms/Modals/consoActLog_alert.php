...
<body onload="myFunction();" style="font-family: Montserrat;">
  ...
  <div class="modal modal-fx-fall" id="consoActLogModal" overflow-y:visible;>
    <div class="modal-background"></div>
    <div class="modal-card">
      <header class="modal-card-head is-success">
        <p class="modal-card-title">SALES</p>
      ...
      <section class="modal-card-body" id="modalbody">
       ...
       <footer class="modal-card-foot" >
        <a href="conso-act.php"><button class="button is-danger" style="font-family: Montserrat;"><i class="fas fa-arrow-left"></i>&nbspBACK</button></a>
      </footer>
    </div>
  </div>
...
<script>
 ...
 function myFunction() {
  ...
  var warrantyModal = document.querySelector('#consoActLogModal');
