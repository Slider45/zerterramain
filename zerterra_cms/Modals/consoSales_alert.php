...
<body onload="myFunction();" style="font-family: Montserrat;">
  ...
  <div class="modal modal-fx-fall" id="consoSalesModal" overflow-y:visible;>
    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body" id="modalbody">
       ...
       <footer class="modal-card-foot" >
        <a href="conso-sales.php"><button class="button is-danger" style="font-family: Montserrat;"><i class="fas fa-arrow-left"></i>&nbspBACK</button></a>
      </footer>
    </div>
  </div>
...
<script>
 ...
 function myFunction() {
  ...
  var warrantyModal = document.querySelector('#consoSalesModal');
