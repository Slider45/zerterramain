...
?>
    ...
    <a href="request-repair.php" class="w3-bar-item w3-button w3-hover-white" id="request-repair"><i class="fas fa-tools"></i> &nbsp&nbsp&nbsp&nbsp&nbspRequest for Repair</a>
